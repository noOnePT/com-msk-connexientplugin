 ...
 */
+ (BOOL)saveValue:(nonnull id)value forKey:(nonnull NSString*)key forAccessGroup:(nullable NSString *)group;
...
/**
 ...
 @return YES if saved successfully, NO otherwise.
 */
+ (BOOL)saveValue:(nonnull id)value forKey:(nonnull NSString*)key;
 ...
 */
+ (BOOL)deleteValueForKey:(nonnull NSString *)key forAccessGroup:(nullable NSString *)group;
...
/**
 ...
 @return YES if deletion was successful, NO if the value was not found or some other error ocurred.
 */
+ (BOOL)deleteValueForKey:(nonnull NSString *)key;
 ...
 */
+ (nullable id)loadValueForKey:(nonnull NSString*)key forAccessGroup:(nullable NSString *)group;
...
/**
 ...
 @return The value identified by key or nil if it doesn't exist.
 */
+ (nullable id)loadValueForKey:(nonnull NSString*)key;
 ...
 */
+ (nullable NSString *)getBundleSeedIdentifier;
